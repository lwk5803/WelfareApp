...
CTPV_NAME_ALIASES = {
    # "서울시"처럼 "시/도"까지 붙은 약칭뿐 아니라, "서울"처럼 그것마저 뗀 가장 흔한
    # 표기도 같이 정식 명칭으로 바꿔줍니다 - 정부 API가 지금은 관대하게 봐주는
    # 것으로 확인됐지만(직접 호출해서 검증함), 이건 API가 그렇게 해준다는 보장이
    # 있는 게 아니라서 미리 정식 명칭으로 맞춰두는 편이 안전합니다.
    "서울": "서울특별시",
    "서울시": "서울특별시",
    "부산": "부산광역시",
    "부산시": "부산광역시",
    ...
    "인천": "인천광역시",
    "인천시": "인천광역시",
    # 주의: "광주"는 광주광역시와 경기도 광주시가 이름이 겹칩니다. 주소에 "경기도"가
    # 먼저 나오면(예: "경기도 광주시 ...") 앞 토큰이 "경기도"라 이 매핑과 무관하지만,
    # "경기도"를 생략하고 "광주시 ..."로만 적으면 광주광역시로 잘못 인식됩니다.
    # 현재 등록된 회원 중 이 경우는 없어서 급하게 손대지 않았습니다 - 실제로 경기
    # 광주시 회원이 생기면 주소를 "경기도 광주시 ..."로 입력해달라고 안내해주세요.
    "광주": "광주광역시",
    "광주시": "광주광역시",
    "대전": "대전광역시",
    "대전시": "대전광역시",
